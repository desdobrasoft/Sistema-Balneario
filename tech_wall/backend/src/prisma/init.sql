...
VALUES
    -- Fundação
    ('concreto', 'Concreto', 0, 'm³', 1),
    ('malha-ferro', 'Malha de ferro', 0, 'un', 1),
    ('painel-concreto', 'Painel de concreto leve + frete', 0, 'un', 1),
    ('prego-17x27', 'Pregos 17/27', 0, 'un', 1),
    ('tabuas-3m-20cm', 'Tábuas 3m x 20cm', 0, 'un', 1),
    ('ripao', 'Ripão (sarrafos)', 0, 'un', 1),
    ('viga-madeira-6x12-3m', 'Vigas de madeira 6x12 (3m)', 0, 'un', 1),
    -- Estrutura
    ('caibros-5x5', 'Caibros 5x5', 0, 'un', 2),
    -- Cobertura
    ('telhas', 'Telhas (eternit + cumeeira + parafusos)', 0, 'un', 3),
    -- Instalações Hidráulicas
    ('barra-cano-100', 'Barra de cano 100mm', 0, 'un', 4),
    ('barra-cano-25', 'Barra de cano 25mm', 0, 'un', 4),
    ('luvas-100-esgoto', 'Luvas 100mm / esgoto', 0, 'un', 4),
    ('luvas-25', 'Luvas 25mm', 0, 'un', 4),
    ('curva-100', 'Curva 100mm', 0, 'un', 4),
    ('joelhos-100', 'Joelhos 100mm / esgoto', 0, 'un', 4),
    ('joelho-90-sem-rosca-25', 'Joelho 90º sem rosca 25mm', 0, 'un', 4),
    ('tampao-100-25', 'Tampão (100mm / 25mm)', 0, 'un', 4),
    ('cola-cano', 'Cola para cano hidráulico', 0, 'un', 4),
    ('torneiras', 'Torneiras', 0, 'un', 4),
    -- Instalações Elétricas
    ('rolo-fio-2.5mm', 'Rolo de fio 2,5mm (preto/vermelho/branco)', 0, 'un', 5),
    ('tomadas', 'Tomadas', 0, 'un', 5),
    ('fita-isolante', 'Fita isolante', 0, 'un', 5),
    ('rolo-conduite-3-4', 'Rolo de conduite 3/4', 0, 'un', 5),
    ('bocal-luz', 'Bocal de luz', 0, 'un', 5),
    -- Esquadrias
    ('janela-blindex-160x100', 'Janela blindex 1,60m x 1,00m', 0, 'un', 6),
    ('porta-blindex-215x080', 'Porta blindex 2,15m x 0,80m', 0, 'un', 6),
    ('janela-correr-120x100', 'Janela de correr 1,20m x 1,00m', 0, 'un', 6),
    ('janela-basculante-060x040', 'Janela basculante 0,60m x 0,40m', 0, 'un', 6),
    ('janela-basculante-040x100', 'Janela basculante 0,40m x 1,00m', 0, 'un', 6),
    ('porta-abrir-215x070', 'Porta de abrir 2,15m x 0,70m', 0, 'un', 6),
    ('porta-aluminio-215x070', 'Porta de alumínio 2,15m x 0,70m', 0, 'un', 6),
    ('porta-madeira-215x070', 'Porta de madeira 2,15m x 0,70m', 0, 'un', 6),
    -- Acabamento
    ('argamassa-c3', 'Argamassa C3', 0, 'un', 7),
    (
    ...
    ('massa-textura-20kg', 'Massa textura 20kg', 0, 'un', 7),
    ('galao-selador', 'Galão de selador', 0, 'un', 7),
    ('tinta-18l', 'Tinta 18L', 0, 'galões', 7),
    -- Serviços
