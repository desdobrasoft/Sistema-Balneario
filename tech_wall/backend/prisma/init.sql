...
BEGIN
    IF NEW.qt_estoque > OLD.qt_estoque THEN
        NEW.ultima_entrada := NOW();
    ELSIF NEW.qt_estoque < OLD.qt_estoque THEN
...
UPDATE ON materiais_estoque FOR EACH ROW WHEN (OLD.qt_estoque IS DISTINCT FROM NEW.qt_estoque)
...
VALUES
    (
        'admin',
        '$2a$12$.FA1UbBHBnXY4wgiadR94O1PYY8GOy7M4L3.5uLL1FZRenhRyzYva',
        'Administrador'
    );
...
INSERT INTO
    materiais_estoque (id, nome)
VALUES
    ('barra-cano-100', 'BARRA DE CANO 100'),
    ('barra-cano-25', 'BARRA DE CANO 25'),
    ('luvas-100-esgoto', 'LUVAS 100 / ESGOTO'),
    ('luvas-025', 'LUVAS 0,25'),
    ('curva-100', 'CURVA 100'),
    ('joelhos-100', 'JOELHOS 100 / ESGOTO'),
    ('joelho-90-sem-rosca', 'JOELHO 90 GRAU / SEM ROSCA'),
    ('tampao', 'TAMPÃO'),
    ('lixas-acrilicas', 'LIXAS (PARA MASSAS ACRILICAS)'),
    ('cola-pvc', 'COLA (PARA CANO DA HIDRAULICA)'),
    ('torneiras', 'TORNEIRAS'),
    ('rolos-fio-25', 'ROLOS DE FIO 2,5 (PRETO/VERMELHO/BRANCO)'),
    ('tomadas', 'TOMADAS'),
    ('fita-isolante', 'FITA ISOLANTE'),
    ('rolo-conduite-34', 'ROLO DE CONDUITE 3/4'),
    ('bocal-luz', 'BOCAL DE LUZ'),
    ('malha-ferro', 'MALHA DE FERRO'),
    ('concreto', 'CONCRETO'),
    ('prego-17x27', 'PREGO 17/27'),
    ('telhas', 'TELHAS (eternit+cumunheira+parafusos)'),
    ('argamassa-c3', 'ARGAMASSA C3'),
    ('tinta-18l', 'TINTA 18L'),
    ('massa-textura-20k', 'MASSA TEXTURA 20K'),
    ('galao-selador', 'GALÃO SELADOR'),
    ('janela-blindex-160x100', 'JANELA BLINDEX 1.60x1.0'),
    ('porta-blindex-215x080', 'PORTA BLINDEX 2.15x0.80'),
    ('janela-correr-120x100', 'JANELA DE CORRER 1.20x1.0'),
    ('janela-basculante-060x040', 'JANELA BASCULANTE 0.60X0.40'),
    ('janela-basculante-040x100', 'JANELA BASCULANTE 0.40X1.0'),
    ('porta-abrir-215x070', 'PORTA DE ABRIR 2.15X0.70'),
    ('porta-aluminio-215x070', 'PORTA DE ALUMÍNIO 2.15X0.70'),
    ('tabuas-3m-20cm', 'TÁBUAS 3m 20cm'),
    ('ripao', 'RIPÃO (SARAFOS)'),
    ('viga-madeira-6x12-3m', 'VIGAS DE MADEIRA 6/12 3m'),
    ('caibros-5x5', 'CAIBROS 5/5'),
    ('porta-madeira-215x070', 'PORTA MADEIRA 2.15X0.70'),
    ('painel-concreto', 'PAINEL DE CONCRETO LEVE + FRETE');
