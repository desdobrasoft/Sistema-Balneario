            ...
            children: [
              FutureBuilder<List<MateriaisEstoque>>(
                ...
                builder: (context, snapshot) {
                  ...
                  materiais.sort((a, b) {
                    final discrepanciaA = a.limBaixoEstoque - a.qtEstoque;
                    final discrepanciaB = b.limBaixoEstoque - b.qtEstoque;
                  ...
                  return DropdownButtonFormField<MateriaisEstoque>(
                    ...
                    items: materiais.map((material) {
                      final isLowStock =
                          material.qtEstoque < material.limBaixoEstoque;
                      ...
                      return DropdownMenuItem(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              '(Est: ${material.qtEstoque} / Mín: ${material.limBaixoEstoque})',
