...
class _VerDetalhesDialogState extends State<VerDetalhesDialog> {
  ...
  Future<void> _onPressedExcluir() async {
    final accept =
        await DialogService.instance.showDialog(
          BooleanDialog(
            title: 'Excluir Modelo',
            content:
                'Tem certeza que deseja excluir o modelo "${_modelo.nome}"?\nEsta ação não pode ser desfeita.',
          ),
    ...
    final success = await ModelosCasasApi.removeModeloCasa(_modelo);
    if (success && mounted) {
                        ...
                        return Column(
                          ...
                          children: List.generate(
                            ...
                            (i) {
                              ...
                              return Row(
                                children: [
                                  Expanded(child: Text(materiais[i].nome)),
                                  SizedBox(
                                    width: _qtdeWidth,
                                    child: TextFormField(
    ...
    return AlertDialog(
      ...
      title: Row(
        ...
        children: [
          ...
          IconButton(
            onPressed: _onPressedExcluir,
            icon: Icon(Icons.delete_outline, color: _scheme.error),
            tooltip: 'Excluir',
          ),
          IconButton(
              ...
              Column(
                children: _modelo.materiais.map((materialRequerido) {
                  return ListTile(
                    ...
                    title: Text(materialRequerido.material.nome),
                    trailing: Text(
  ...
  Widget _buildSelect() {
    return MultiDropdown(
      ...
      fieldDecoration: FieldDecoration(
        ...
        borderRadius: 0,
        labelText: 'Materiais',
        hintText: _materiais?.firstOrNull?.nome,
        hintStyle: hintStyle(context),
      ),
