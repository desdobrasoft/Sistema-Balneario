...
class Preferences with ChangeNotifier {
  ...
  ThemeMode _tema = PrefEntry.tema.dflt;
  ...
  Future<void> load() async {
    try {
      ...
      _tema = _temaFromString(json[PrefEntry.tema.key]);
  ...
  ThemeMode _temaFromString(String? tema) {
    switch (tema) {
      case 'light':
